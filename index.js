...
Truck.prototype.specific = function (weight) {
  if (weight >= this.towingCapacity) {
    console.log(`Навантаження ${weight} занадто важке для буксирування`);
  } else {
    console.log(`Тягнення навантаження ${weight} кг`);
  }
};
...
Car.prototype.drive = function (kilometers) {
  ...
  console.log(
    `Подорожуємо ${kilometers} кілометрів у ${this.brand} ${this.kilometers} .`
  );
};
